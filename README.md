...
![Lint to detailed report](images/link_to_detailed_report.jpg)

Follow the links to read the detailed report in 42Crunch Platform:

![platform_Security_Audit](images/42Crunch_platform_Security_Audit.png)
...
![REST_API_Code_Scanning_Alerts](images/42Crunch_GitHub-REST_API_Code_Scanning_Alerts.png)
...
![Alert_Details](images/42Crunch_GitHub-Alert_Details.png)
